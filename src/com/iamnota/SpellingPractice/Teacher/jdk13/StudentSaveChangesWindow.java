...
public class StudentSaveChangesWindow
{
    private static final String TITLE = "Save changes to student";
    ...
    public static boolean askSaveChanges(StudentController studentController)
    {
