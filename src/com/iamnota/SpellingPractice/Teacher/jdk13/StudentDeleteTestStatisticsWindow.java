/*
 * StudentDeleteTestStatisticsWindow.java
 *
...
public class StudentDeleteTestStatisticsWindow
{
    private static final String TITLE = "Delete student test statistics";

    private static final String TEMPLATE_CONFIRMATION = "Are you sure you want to delete test statistics for \"\\0\"?";

    private static final String YES = "Yes";
    private static final String NO = "No";


    public StudentDeleteTestStatisticsWindow(StudentController studentController)
    {
	...
	if (isDelete)
	{
	    studentController.deleteTestStatistics();
	}
    }
}
