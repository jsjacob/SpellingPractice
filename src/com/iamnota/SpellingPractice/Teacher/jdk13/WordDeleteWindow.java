...
public class WordDeleteWindow
{
    private static final String TITLE = "Delete word";

    private static final String TEMPLATE_CONFIRMATION = "Are you sure you want to delete \"\\0\"?";

    private static final String YES = "Yes";
    private static final String NO = "No";


    public WordDeleteWindow(WordController wordController)
    {
