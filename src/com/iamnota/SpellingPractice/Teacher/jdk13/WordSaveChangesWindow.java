...
public class WordSaveChangesWindow
{
    private static final String TITLE = "Save changes to word";

    private static final String TEMPLATE_CONFIRMATION = "Save changes to \"\\0\"?";

    private static final String YES = "Yes";
    private static final String NO = "No";

    public static boolean askSaveChanges(WordController wordController)
    {
	String confirmation = TextUtils.replaceTokens(TEMPLATE_CONFIRMATION, new String[] { wordController.getWordModel().getWord() });
