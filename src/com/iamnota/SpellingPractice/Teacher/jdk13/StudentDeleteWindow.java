...
public class StudentDeleteWindow
{
    private static final String TITLE = "Delete student";
    ...
    public StudentDeleteWindow(StudentController studentController)
    {
