    ...
    implements LogView
{
    ...
    private static final String TITLE_WARNING = "Warning - Teacher - SpellingPractice";
    private static final String TITLE_ERROR = "Error - Teacher - SpellingPractice";

    private static final String LOG_FILENAME = "TeacherLog.txt";
    ...
    {
	String logLevel = this.controller.getPreferenceController().getLogLevel();
