...
public class StudentCorrectPanel
    extends JPanel
{
    ...
    public StudentCorrectPanel(StudentController studentController, StudentModel studentModel)
    {
	...
	Vector words = new Vector(this.studentModel.getCorrectIdsToWords().values());
