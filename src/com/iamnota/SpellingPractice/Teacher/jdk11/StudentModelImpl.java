    ...
    implements StudentModel
{
    ...
    private boolean isShowTestingStatistics;
    private boolean isShowDirectedStatistics;
    private Map correctIdsToWords;
    private Map incorrectIdsToWords;
    ...
    {
	correctIdsToWords = new HashMap();
	incorrectIdsToWords = new HashMap();
    }
    ...
    public void setCorrectIdsToWords(Map correctIdsToWords)
    {
	this.correctIdsToWords = correctIdsToWords;
    }

    public Map getCorrectIdsToWords()
    {
	return this.correctIdsToWords;
    }

    public void setIncorrectIdsToWords(Map incorrectIdsToWords)
    {
	this.incorrectIdsToWords = incorrectIdsToWords;
    }

    public Map getIncorrectIdsToWords()
    {
	return this.incorrectIdsToWords;
    }
}
