...
public class SavingCloseView
    extends Saving
{
    private static SavingCloseView me;

    protected SavingCloseView()
    {
	;
    }
    ...
    {
	if (SavingCloseView.me == null)
	{
	    SavingCloseView.me = new SavingCloseView();
	}

	return SavingCloseView.me;
    }

    public String getName()
    {
	return "SavingCloseView";
    }
	...
	return IdleNotModified.getInstance().unload(studentController).closeView(studentController);
    }
}
